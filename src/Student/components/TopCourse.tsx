  ...
  return (
    <section className="relative py-6 sm:py-8 md:py-10 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20 overflow-hidden">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 sm:mb-10 md:mb-14 gap-3 sm:gap-4">
        ...
        <button
          className="w-[70px] sm:w-20 md:w-[89px] h-8 sm:h-[34px] md:h-9 gap-2 sm:gap-2.5 text-white font-semibold py-1 sm:py-2 px-3 sm:px-4 rounded-sm text-xs sm:text-sm md:text-base transition-all duration-300 whitespace-nowrap"
          style={{
