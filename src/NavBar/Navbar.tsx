...
const Navbar: React.FC = () => {
  ...
  return (
    <div>
      <nav className="shadow-md sticky top-0 z-50 w-full" style={{ ...(FONTS.regular as any), background: COLORS.primary_white }}>
        <div className="flex flex-wrap items-center justify-between px-5 md:px-7 py-4 md:py-7 gap-4">
          ...
          <div className="hidden xl:flex items-center gap-2 flex-wrap text-center" style={FONTS.regular as any}>
          ...
          <div className="flex items-center gap-4 shrink-0">
            ...
            <div className="hidden md:flex items-center p-2 rounded w-48" style={{ background: '#FFFBD3' }}>
            ...
            <div className="hidden xl:flex items-center gap-4">
              <Link to="/cartPage">
                <img src={carticon} className='rounded-full p-2 w-10 h-10' style={{ background: COLORS.primary_yellow }} />
              </Link>
              <Link to="/notificationPage">
                <img src={notify} className="rounded-full p-2 w-10 h-10 cursor-pointer" style={{ background: COLORS.primary_red }} />
              </Link>
            </div>
    ...
    >
      ...
      Logout
        ...
        {menuOpen && (
          <div className="xl:hidden flex flex-col items-center gap-4 py-4 border-t w-full" style={{ background: COLORS.primary_white }}>
            ...
            <NavLink to="/institutes" onClick={() => setMenuOpen(false)} 
            className="hover:text-red-600" style={{ color: COLORS.primary_gray }}>
              Institutes
            </NavLink>
            ...
            <NavLink to="/Queries" onClick={() => setMenuOpen(false)} 
            className="hover:text-red-600" style={{ color: COLORS.primary_gray }}>
              Queries
            </NavLink>
          </div>
